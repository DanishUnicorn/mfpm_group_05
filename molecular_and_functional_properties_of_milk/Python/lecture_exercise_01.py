...
print("velocity of the fat globule is {:.10f} m/s.".format(v_P))
print("The time taken for the fat globule to rise to the top of the glass is {:.2f} seconds.".format(t))
print("The time taken for the fat globule to rise to the top of the glass is {:.2f} minutes.".format(t_min))
print("The time taken for the fat globule to rise to the top of the glass is {:.2f} hours.".format(t_hour))
print("The time taken for the fat globule to rise to the top of the glass is {:.2f} days.".format(t_day))
...
# Calculate the time taken for the fat globule to rise to the top of the glass
t = (h_glass/100)/v_P_2 # Convert height of the glass from cm to m
t_min = t/60
t_hour = t_min/60
t_day = t_hour/24

# Print the time taken for the fat globule to rise to the top of the glass
print("velocity of the big fat globule is {:.10f} m/s.".format(v_P_2))
print("The time taken for the big fat globule to rise to the top of the glass is {:.2f} seconds.".format(t))
print("The time taken for the big fat globule to rise to the top of the glass is {:.2f} minutes.".format(t_min))
print("The time taken for the big fat globule to rise to the top of the glass is {:.2f} hours.".format(t_hour))
print("The time taken for the big fat globule to rise to the top of the glass is {:.2f} days.".format(t_day))